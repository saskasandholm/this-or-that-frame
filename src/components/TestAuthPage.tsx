    ...
    <div className="container mx-auto py-8">
        ...
        <div className="mb-4">
          ...
          {isAuthenticated && profile && (
            <div className="mt-2">
              ...
              {profile.pfpUrl && (
                <p className="mb-1">
                  <strong>Profile Image:</strong> {profile.pfpUrl}
                </p>
              )}
            </div>
          )}
      ...
      {sessionData && (
        <div className="mb-6 p-4 border rounded-lg">
          ...
          <div className="overflow-auto max-h-60 p-4 bg-gray-900 text-gray-100 rounded-md">
            <pre className="whitespace-pre-wrap break-all text-xs">{sessionData}</pre>
          </div>
        </div>
      )}
      ...
      <div className="mb-6 p-4 border rounded-lg">
        ...
        <div className="flex gap-2 flex-wrap">
          <Link href="/" className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md">
            Home
          </Link>
          <a
            href="#"
